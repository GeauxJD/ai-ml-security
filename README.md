...
* Project: **Security-Focused Guide for AI Code Assistant Instructions**
  ...
  * Published Document: [Security-Focused Guide for AI Code Assistant Instructions](https://best.openssf.org/Security-Focused-Guide-for-AI-Code-Assistant-Instructions), to be released 2025-10-16
  ...
  * Working Document: [Security-Focused Guide for AI Code Assistant Instructions - Working Document](https://github.com/ossf/wg-best-practices-os-developers/blob/main/docs/Security-Focused-Guide-for-AI-Code-Assistant-Instructions.md)  
* Project: **Secure AI/ML-Driven Software Development (LFEL1012)**
  * Published Material: [Secure AI/ML-Driven Software Development (LFEL1012)](https://training.linuxfoundation.org/express-learning/secure-ai-ml-driven-software-development-lfel1012), to be released 2025-10-16. Developed with the OpenSSF AI/ML WG.
