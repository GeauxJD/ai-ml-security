# Contributing to the OpenSSF AI/ML Security Working Group

Welcome! We're excited that you're interested in contributing to the Artificial Intelligence / Machine Learning (AI/ML) Security Working Group. We aim to create a supportive, inclusive environment where everyone can thrive and make meaningful contributions.
...
- **Slack Channel:** Join the conversation on our #wg-ai-ml-security [OpenSSF Slack channel](https://openssf.slack.com/archives/C0587E513KR). This is the best place to ask questions, share ideas, and collaborate.
...
- Join our #wg-ai-ml-security channel via the [OpenSSF Slack channel](https://openssf.slack.com/archives/C0587E513KR).

- Attend working group meetings listed on the public calendar.

### 2. Report Issues or Suggest Enhancements

- Use the [GitHub Issues](https://github.com/ossf/ai-ml-security/issues) tab to report problems or suggest ideas.
